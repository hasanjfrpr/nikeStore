...
import com.example.digikala.common.setupWithNavController
...
class MainActivity : NikeActivity() {
    ...
    fun getCountItemCartBadge(cartItemCount: CartItemCount){
           val badge=bottomNavigationMain.getOrCreateBadge(R.id.cart)
           badge.backgroundColor=MaterialColors.getColor(bottomNavigationMain,R.attr.colorSecondary)
           badge.badgeGravity=BadgeDrawable.BOTTOM_START
           badge.verticalOffset = dpToPx(10,this)
    ...
    override fun onResume() {
        super.onResume()
    thisViewModel.getCountItemCart()
